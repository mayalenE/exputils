...
def calc_experiment_statistics(statistics, load_experiment_data_func,  *args, statistics_directory='statistics', verbose=False):
    '''
    ...
    for folder in experiments:
        ...
        # look if there are repetition folders
        ...
        if not found_folders:
            raise Warning('Could not find experiments in directory {!r}.'.format(folder))
